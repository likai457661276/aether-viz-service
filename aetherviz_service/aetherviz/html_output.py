...
from aetherviz_service.aetherviz.validator import sanitize_aetherviz_html, validate_basic_aetherviz_html
...
def parse_and_validate_html(raw_html: str, topic: str, plan: dict) -> tuple[str, list[str]]:
    ...
    warnings = validate_basic_aetherviz_html(cleaned_html, topic=topic)
