...
def test_planning_and_html_models_are_configured_separately(monkeypatch) -> None:
    ...
    monkeypatch.setattr(settings, "aetherviz_edit_patch_max_tokens", 3072)
    ...
    model_factory.create_chat_model("edit_patch")
    ...
    assert [kwargs["max_tokens"] for kwargs in captured] == [3072, 8192, 9216, 3072, 9216]
